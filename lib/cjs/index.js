...
var SimpleNavbar = function (_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("div", { id: "header", style: { "transition": "all .4s ease-in-out", "height": navbarHeight }, className: "z-10 fixed top-0 left-0 w-full text-white hover:" + bgColorOnHover + " navbarGradient" },
            react_1.default.createElement("div", { className: "h-full flex justify-between items-center gap-4" },
                ...
                react_1.default.createElement("nav", { className: "hidden lg:flex lg:flex-row lg:items-center gap-4 text-xl" }, links.map(function (e, i) {
        ...
        react_1.default.createElement("div", { className: "z-9 fixed w-full bg-gray-100", style: { opacity: menuOpen ? 1 : 0, "height": menuOpen ? maxMenuVh : '0vh', "transition": "all 0.4s ease-in-out" } }, menuOpen ?
            react_1.default.createElement("div", { style: { "height": menuOpen ? '90vh' : '0vh', "transition": "all 0.4s ease-in-out" } },
                ...
                react_1.default.createElement("div", { className: "pr-2 pt-10 w-full text-center", onClick: function () { setMenuOpen(false); } }, "\u25B2"))
