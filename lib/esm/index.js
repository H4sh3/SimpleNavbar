...
var SimpleNavbar = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { id: "header", style: { "transition": "all .4s ease-in-out", "height": navbarHeight }, className: "z-10 fixed top-0 left-0 w-full text-white hover:" + bgColorOnHover + " navbarGradient shadow" },
        ...
        React.createElement("div", { className: "lg:hidden shadow z-9 fixed w-full bg-gray-100", style: { opacity: menuOpen ? 1 : 0, "height": menuOpen ? maxMenuVh : '0vh', "transition": "all 0.4s ease-in-out" } }, menuOpen ?
